...
// Accept optional class so Astro client:* directives type-check against a non-empty props type
interface Props {
	class?: string;
}
...
<div class="relative z-50" translate="no" role="menu" tabindex="-1" onmouseleave={hidePanel}>
